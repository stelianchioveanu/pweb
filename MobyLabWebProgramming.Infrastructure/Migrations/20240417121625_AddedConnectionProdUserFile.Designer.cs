...
namespace MobyLabWebProgramming.Infrastructure.Migrations
{
    ...
    [Migration("20240417121625_AddedConnectionProdUserFile")]
    partial class AddedConnectionProdUserFile
    {
            ...
            modelBuilder.Entity("MobyLabWebProgramming.Core.Entities.UserFile", b =>
                {
                    b.HasOne("MobyLabWebProgramming.Core.Entities.Product", "Product")
                        .WithOne("UserFile")
                        .HasForeignKey("MobyLabWebProgramming.Core.Entities.UserFile", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
