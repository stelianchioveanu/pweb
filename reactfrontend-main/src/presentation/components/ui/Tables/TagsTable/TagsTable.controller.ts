 ...
 */
export const useProductsTagsTableController = () => {
    const { getTags: { key: queryKey, query }, deleteTag: { key: deleteTagKey, mutation: deleteTag } } = useProductTagsApi(); // Use the API hook.
