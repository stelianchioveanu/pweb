            ...
            <ContentCard title={formatMessage({ id: "globals.register" })}>
                <Grid container item direction="row" xs={12} columnSpacing={4}>
                    ...
                    <Grid container item direction="column" xs={12} md={12}>
                        <FormControl
                            fullWidth
                            error={!isUndefined(state.errors.confPass)}
                        >
                            <FormLabel required>
                                <FormattedMessage id="globals.confPass" />
                            </FormLabel>
                            <OutlinedInput
                                type="password"
                                {...actions.register("confPass")}
                                placeholder={formatMessage(
                                    { id: "globals.placeholders.textInput" },
                                    {
                                        fieldName: formatMessage({
                            ...
                            />
                            <FormHelperText
                                hidden={isUndefined(state.errors.confPass)}
                            >
                                {state.errors.confPass?.message}
                            </FormHelperText>
                        </FormControl>
                    </Grid>
                </Grid>
